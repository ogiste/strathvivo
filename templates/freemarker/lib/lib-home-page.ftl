                        ...
                        <#if !group.uri?contains("equipment") && !group.uri?contains("course") >
                            <li>
                                <a href="${urls.base}/browse">
                                    <button class="btn btn-default home-sec-btn" type="button">
    ...
    <ul>
        <#list classGroups as group>
            <#if (group.individualCount > 0) && group.uri?contains("publications") >
                ...
                <li><a href="${urls.base}/research" alt="${i18n().view_all_research}" class='btn btn-default home-sec-btn' >${i18n().view_all}</a></li>
            </#if>
        </#list>
        <#if !foundClassGroup>
...
<#macro academicDeptsHtml>
    <section id="home-academic-depts" class="home-sections">
        <h4 class="strath-depts-header">${i18n().departments}</h4>
